  ...
  <div>
    ...
    <el-row>
      ...
      >
        ...
        <el-table-column prop="address" label="激活时间" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="address" label="激活用户邮箱" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="address" label="用户名" show-overflow-tooltip>
        </el-table-column>
      </el-table>
    </el-row>
    <el-row>
